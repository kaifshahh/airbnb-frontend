...
const SignupPage = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-linear-to-br from-red-50 via-white to-pink-50 py-12 px-4 relative overflow-hidden">
      ...
      <div
        ref={formRef}
        className="relative z-10 backdrop-blur-lg bg-white/70 p-8 md:p-10 rounded-3xl shadow-2xl w-full max-w-lg border border-white/20"
      >
            ...
            <div className="flex gap-4">
              <label className="flex-1 cursor-pointer">
                <input
                  ...
                  required
                />
                <div className="p-4 border-2 border-gray-200 rounded-xl peer-checked:border-red-500 peer-checked:bg-red-50 transition-all hover:border-red-300 bg-white/50 backdrop-blur-sm text-center">
          ...
          <div className="form-field">
            <label className="flex items-start cursor-pointer">
              <input
                ...
                onChange={handleChange}
                className="mt-1 mr-3 h-5 w-5 text-red-500 rounded focus:ring-red-400"
                required
              />
